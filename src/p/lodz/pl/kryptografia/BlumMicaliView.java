...
public class BlumMicaliView extends JFrame {
	...
	public BlumMicaliView() {
		...
		JLabel lblKlucz = new JLabel("Klucz Blum-Micali");
		...
		btnOpenKeys = new JButton("Wczytaj klucz");
		btnOpenKeys.setBounds(26, 229, 172, 25);
		getContentPane().add(btnOpenKeys);
		
		btnSaveKeys = new JButton("Zapisz klucz");
		...
		btnGenerateKeys = new JButton("Generuj klucz");
		btnGenerateKeys.setBounds(26, 90, 172, 25);
